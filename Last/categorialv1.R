...
tallas <- sort(pvtalla[1:muestra,1])
colores <- pvcolor[1:muestra,1]
ids <- sort(pvid[1:muestra,1])
...
barplot(joint_counts_cat_talla, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "TALLA")
title("TOMMY")
...
barplot(joint_counts_color, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "COLOR")
title("TOMMY")
legend('topright', levels(CATEGORIA), pch=15, col=brewer.pal(10,"Paired"), ncol = 4,  cex=0.75)
...
barplot(joint_counts_id, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "ID_TIENDA")
title("TOMMY")
legend('topright', levels(CATEGORIA), pch=15, col=brewer.pal(10,"Paired"), ncol = 4,  cex=0.75)
...
barplot(joint_counts_ubicacion, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "UBICACION",las=2)
title("TOMMY")
legend('topright', levels(CATEGORIA), pch=15, col=brewer.pal(10,"Paired"), ncol = 4,  cex=0.75)
...
barplot(joint_counts_sku, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "TALLA",las=2)
title("TOMMY")
legend('topright', levels(CODIGO_SKU), pch=15, col=brewer.pal(10,"Paired"), ncol = 4,  cex=0.75)


joint_id_talla <- CrossTable(ID_TIENDA, TALLA, prop.chisq = FALSE)
joint_counts_id_talla <- joint_id_talla$t

barplot(joint_counts_id_talla, beside = TRUE, col=brewer.pal(10,"Paired"), ylab = "Frequency", xlab = "TALLA",las=2)
title("TOMMY")
